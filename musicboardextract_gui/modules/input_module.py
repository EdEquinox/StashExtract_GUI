...
def input_module_label(app, text):
    label = customtkinter.CTkLabel(app, text=text, width=300, height=30, font=("Arial", 15), corner_radius=10)
    return label
    
    
def input_module_form(app):
    text_input = customtkinter.CTkEntry(app)
    button = customtkinter.CTkButton(app, text="Extract!", fg_color='blue')
